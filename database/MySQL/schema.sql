...
CREATE TABLE tokens (
  ...
  `name` VARCHAR(255) NULL DEFAULT NULL,
  `icon` VARCHAR(255) NULL DEFAULT NULL,
  `totalSupply` VARCHAR(255) NULL DEFAULT NULL,
  `exchangeRate` VARCHAR(255) NULL DEFAULT NULL,
  `decimals` TINYINT(2) UNSIGNED NOT NULL,
  `maxMeltFee` VARCHAR(255) NULL DEFAULT NULL,
  `meltFee` VARCHAR(255) NULL DEFAULT NULL,
  `transferable` TINYINT(1) UNSIGNED NOT NULL,
